                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _CreateBtn(isLoading: auth.isLoading, onTap: _submit, isDark: isDark)
                          .animate().fadeIn(delay: 300.ms),

                      const SizedBox(height: 48),

                      Text(
                        'By creating an account, you agree to DroneHub\'s Terms of Service and Privacy Policy.',
          ...
          Positioned(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                Text(
                  'Join thousands of drone pilots\nbuilding with professional-grade components.',
                  style: TextStyle(
                    fontSize: 15,
...
class _CreateBtn extends StatelessWidget {
  ...
  final VoidCallback onTap;
  final bool isDark;
  const _CreateBtn({required this.isLoading, required this.onTap, required this.isDark});
